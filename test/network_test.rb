...
class NetworkTest < Minitest::Test
  ...
  def test_it_has_characters
    ...
    assert_equal [michael_knight, kitt, leslie_knope, ron_swanson], nbc.network_characters
  end
  ...
  def test_it_has_actors_by_show
    ...
    assert_equal ["David Hasselhoff", "William Daniels"], nbc.show_actor_names(knight_rider)
  end

  def test_it_has_characters_by_show
    nbc = Network.new("NBC")
    michael_knight = Character.new({name: "Michael Knight", actor: "David Hasselhoff", salary: 1_600_000})
    kitt = Character.new({name: "KITT", actor: "William Daniels", salary: 1_000_000})
    knight_rider = Show.new("Knight Rider", "Glen Larson", [michael_knight, kitt])
